...
As its linear transformation, not just those two, any vector existing in those respective spans does not get knocked off. 
...
After a linear transformation if we get 2 unique eigendirections. A if we make those eigenvectors as our new basis vectors it is called ***eigen basis***.
